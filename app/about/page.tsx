        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="max-w-screen-lg  sm:text-lg text-gray-400">
            <h2 className="mb-4 text-4xl tracking-tight font-bold text-white">
              Passé, Présent et Futur : l'Histoire Captivante de Bladi
            </h2>
            <p className="mb-4 font-light">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa
              minima repudiandae quo suscipit illo enim, voluptate aperiam
              voluptatum neque? Est ullam eligendi dicta magnam voluptatem vero
              consectetur eius odio. Tempora dolores, sunt nesciunt natus
              reiciendis laborum veniam ullam numquam illo totam maiores dolorem
              quasi soluta id est? Ab excepturi, deserunt iste aperiam neque
              assumenda id necessitatibus minima distinctio velit suscipit nulla
              est accusamus, et natus tempora vel provident porro dicta quidem
              dolores. Numquam, error.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            ...
            <p className="font-light lg:mb-16 sm:text-xl text-gray-400">
              ...
              totam accusantium corporis libero saepe fuga neque amet veritatis
              harum tempora.
            </p>
          </div>
